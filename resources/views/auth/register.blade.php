...
<div class="auth-subtitle">Bắt đầu hành trình học tiếng Anh của bạn hôm nay</div>
    ...
    <div style="margin-bottom:22px;">
        <label class="checkbox-label" for="terms">
            ...
            <span style="font-size:13px;color:var(--text-secondary);">
                Tôi đồng ý với <a href="#" style="color:var(--primary-light);font-weight:600;">Điều khoản sử dụng</a>
                và <a href="#" style="color:var(--primary-light);font-weight:600;">Chính sách bảo mật</a>
            </span>
        </label>
    </div>
...
document.getElementById('registerForm').addEventListener('submit', function () {
    ...
    btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> <span>Đang tạo tài khoản...</span>';
    btn.disabled = true;
});
</script>
@endsection
